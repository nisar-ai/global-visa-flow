...
export const metadata = {
  ...
  description: "Plain-language, step-by-step guides for applying for a tourist, study, work, or PR/citizenship visa.",
};
  ...
  return (
    <section className="px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h1 className="mt-3 text-3xl font-bold sm:text-4xl">Pick a country to see its full guide</h1>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-[var(--text-muted)]">
                {country.visa_categories.map((c) => c.label).join(" · ")}
              </p>
            </div>
          </Link>
        ))}
